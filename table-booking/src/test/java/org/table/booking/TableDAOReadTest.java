...
public class TableDAOReadTest {
	...
	public void readTC1() {
		list = table._tableDAO.read();

		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("free") || table.ID().equals("-2")) {
	...
	public void readTC2() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("reserved") || table.ID().equals("4")) {
	...
	public void readTC3() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("busy") || table.ID().equals("0")) {
	...
	public void readTC4() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("asking") || table.ID().equals("5000")) {
	...
	public void readTC5() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("waiting for food") || table.ID().equals("-2")) {
	...
	public void readTC6() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("served") || table.ID().equals("4")) {
	...
	public void readTC7() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("waiting for the bill") || table.ID().equals("0")) {
	...
	public void readTC8() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("paying") || table.ID().equals("5000")) {
	...
	public void readTC9() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("in preparation") || table.ID().equals("-2")) {
	...
	public void readTC10() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state() == null || table.ID().equals("-2")) {
