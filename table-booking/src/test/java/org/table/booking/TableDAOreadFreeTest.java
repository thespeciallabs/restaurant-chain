...
public class TableDAOreadFreeTest {
	...
	public void readFreeTC1() {
		r.set_diners(-10);
		list = table._tableDAO.readFree(r);

		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("free") && table.ID().equals("-2") && table.get_maxdiners() == -3) {
	...
	public void readFreeTC2() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("reserved") && table.ID().equals("4") && table.get_maxdiners() == 5) {
	...
	public void readFreeTC3() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("busy") && table.ID().equals("0") && table.get_maxdiners() == 7) {
	...
	public void readFreeTC4() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("asking") && table.ID().equals("5000") && table.get_maxdiners() == 0) {
	...
	public void readFreeTC5() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("waiting for food") && table.ID().equals("-2") && table.get_maxdiners() == 6) {
	...
	public void readFreeTC6() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("served") && table.ID().equals("4") && table.get_maxdiners() == 1000) {
	...
	public void readFreeTC7() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("waiting for the bill") && table.ID().equals("0") && table.get_maxdiners() == -3) {
	...
	public void readFreeTC8() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("paying") && table.ID().equals("5000") && table.get_maxdiners() == 5) {
	...
	public void readFreeTC9() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state().equals("in preparation") && table.ID().equals("-2") && table.get_maxdiners() == 7) {
	...
	public void readFreeTC10() {
		...
		while (!list.isEmpty()) {
			table = list.remove();
			if (table.state() == null && table.ID().equals("4") && table.get_maxdiners() == 0) {
