 ...
 * @version 1.0 Class description: This is the main class,
 *          that starts the our application.
 *
 **********************************************************************
 */
class App {
     ...
     * do not change.
     *
     * Description of the Method: The method starts our
     * application, by starting the two interfaces.
     *
     * Calling arguments:
     * @param args The array of Strings that contains the
     *             arguments of our application.
     *
     *             Return value:
     *
     *             It's a void method, so it doesn't return
     *             anything.
     *
     *             Required Files: credentials.properties :
     *             The file that contains the credentials
     *             for our users.
     *
    ...
    public static void main(final String[] args) {
        System.out
                .println("-----\tRestaurant Chain Manager."
                        + "\t(v1.0)\t-----\n");
