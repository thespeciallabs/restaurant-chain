...
* Class version: 
* 				 @version 1.0
* Class description: This class implements an exception for an error with the Menu.
*
**********************************************************************
*/
public class WrongMenuException extends Exception {
	...
	* Calling arguments:
	* 
	* @param message - The message that contains our exception.
	*
	* Return value:
	*
