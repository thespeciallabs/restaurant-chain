...
* Class version: 
* 				 @version 1.0
* Class description: This class implements all the operations related to "Reservation.java", 
* 					 that is our table object, and the database. We have the CRUD operations, 
* 					 with some "Read" operations modification.
*
**********************************************************************
*/
public class ReservationDAO {
	...
	*
	* Description of the Method: The method removes a Reservation object with the information provided by the user.
	*
	* Calling arguments:
	* 
	* @param aR - The reservation object that the user wants to delete.
	*
	* Return value:
	*
	* @return -1 - If the delete operation failed and did not complete.
	...
	* is thrown.
	*
	* @throws Exception e - If there is any kind of failure with the information that we need to delete.
	*********************************************************************/
	...
	* than the author of the file): The authors do not change.
	*
	* Description of the Method: The method creates a Reservation object with the information provided by the user,
	* 							 in order to add it to the Database.
	*
	* Calling arguments:
	* 
	* @param aR - The reservation object that the user wants to add to the Database.
	*
	* Return value:
	*
	* @return -1 - If the create operation failed and did not complete.
	* @return 0  - If the operation was correct.
	*
	* Required Files: 
	* 
	...
	* is thrown.
	*
	* @throws Exception e - If there is any kind of failure with the information that we need to add.
	*********************************************************************/
	...
	* than the author of the file): The authors do not change.
	*
	* Description of the Method: The method checks if a Reservation object with the information 
	* 							 introduced by the user already exists in the Database.
	*
	* Calling arguments:
	* 
	* @param aR - The reservation object that the user created.
	*
	* Return value:
	*
	* @return -1 - If the read operation failed and did not complete.
	* @return 0  - If the operation was correct.
	*
	* Required Files: 
	* 
	...
	* is thrown.
	*
	* @thows Exception e - If there is any kind of failure with the Reservation object created.
	*********************************************************************/
	...
	* than the author of the file): The authors do not change.
	*
	* Description of the Method: The method checks the list of reservations corresponding to a particular Table
	* 							 object, given it's ID.
	*
	* Calling arguments:
	* 
	* @param tableID - The ID of the Table object that the user wants to consult.
	*
	* Return value:
	*
	* @return -1 - If the read operation failed and did not complete.
	...
	* is thrown.
	*
	* @throws Exception e - If there is any kind of failure with the Id of the Table.
	*********************************************************************/
	...
	* than the author of the file): The authors do not change.
	*
	* Description of the Method: The method returns the list of all the reservations that the users have created.
	*
	* Calling arguments:
	* 
	* None.
	...
	* is thrown.
	*
	* @throws Exception e - If there is any kind of failure with the information.
	*********************************************************************/
