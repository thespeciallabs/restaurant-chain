...
* Class version: 
* 				 @version 1.0
* Class description: This class implements all the operations related to "Table.java", that is our table object,
* 					 and the database. We have the CRUD operations, with some "Read" operations modification.
*
**********************************************************************
*/
public class TableDAO {
	...
	* Calling arguments:
	* 
	* @param aT - The reservation object that the user wants to create.
	*
	* Return value:
	*
	* @return -1 - If the update operation failed and did not complete.
	*
	* Required Files: 
	* 
	* None.
	...
	* is thrown.
	*
	* @throws Exception e - If there is any kind of failure with the information that we need to update.
	*********************************************************************/
	...
	* than the author of the file): The authors do not change.
	*
	* Description of the Method: The method checks the information of a particular Table object.
	*
	* Calling arguments:
	* 
	...
	* is thrown.
	*
	* @throws Exception e - If there is any kind of failure with the information that we need to read.
	*********************************************************************/
	...
	* than the author of the file): The authors do not change.
	*
	* Description of the Method: The method returns the complete list of tables that is on the Database.
	*
	* Calling arguments:
	* 
	* None.
	...
	* Return value:
	*
	* @return aux - The list of Tables that is in the Database.
	* @return null - If there was an error retrieving the list of tables from the Database.
	*
	* Required Files: 
	* 
	* None.
	...
	* is thrown.
	*
	* @throws Exception e - If there is any kind of failure with the information on the Database.
	*********************************************************************/
	...
	* than the author of the file): The authors do not change.
	*
	* Description of the Method: The method returns the Tables that are available to the user to book.
	*
	* Calling arguments:
	* 
	* @param r - The reservation that the user wants to make (including the time, to check it's 
	* 			 availability).
	*
	* Return value:
	*
